...
export default function Home() {
    ...
    function renderWindowContent(id: string) {
        switch (id) {
                    ...
                    const processCommand = (cmd: string) => {
                        ...
                        switch (trimmed) {
                            ...
                            case "cat projects.txt":
                                return "Projects: Checkpoint, HAL Boulangerie, Concierge, Takadanobaba Fighters, Portfolio";
                            case "crypto":
                ...
                return <>
                    ...
                    <div className="mt-4">
                        ...
                        <ul>
                            ...
                            <li>2024 - ISI Language School</li>
                            <li>2024 - CG-Arts Web Designer Basic Certificate</li>
            ...
            case "project4":
                return <>
                    <h1 className="text-lg font-bold">Takadanobaba Fighters</h1>
                    <a
                    ...
                    <p className="mt-2">Built using Pixi.js as it's rendering engine, Takadanobaba Fighters runs completely in browser-based JavaScript. Assets are loaded from file, and Pixi.js places the objects on an HTML5 canvas. Other game devices, such as HUD and pop-ups, are rendered in HTML and JavaScript.</p>
